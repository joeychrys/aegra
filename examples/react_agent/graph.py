...
async def call_model(state: State, runtime: Runtime[Context]) -> dict[str, list[AIMessage] | dict[str, Any]]:
    """Call the LLM powering our "agent".

    This function prepares the prompt, initializes the model, and processes the response.
    Token usage is tracked via ``get_usage_metadata_callback()`` and written to state.
    ...
    Returns:
        dict: A dictionary containing the model's response message and token usage.
    """
    ...
    # Get the model's response, tracking token usage
